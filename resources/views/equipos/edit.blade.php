...
<div class="container">
        <div class="row">
            ...
            @endif
                ...
                <form method="post" action="{{action('EquipoController@update', $id)}}">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        @foreach($sedeValues as $key => $val)
                            @if($equipos['sede'] == $key)
                                <option selected value="{{intval($equipos['sede'])}}">{{$val}}</option>
                            @else
                                <option value="{{intval($equipos['sede'])}}">{{$val}}</option>
                            @endif
                        @endforeach
                        </select>
                    </div>
